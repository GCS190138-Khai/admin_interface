...
,{
  ...
  return ( 
    <div className=" text-primary flex flex-col items-center justify-center bg-primaryBlack h-[120vh] w-screen">
          ...
          <div className=' pt-[5vh] border-b border-primary w-[96vw] '></div>
          <div className=" flex  px-[2%] w-screen h-[45%] ">
            ...
            { info.map((item,index)=>{
                return( <div key={index} className='  flex flex-col '>
                  ...
                  <div className={index===1?'flex  w-[19vw] text-aCaption font-title2-caption':'flex w-[19vw] cursor-pointer text-aCaption font-title2-caption '}>{item.button? <u onClick={()=>{
