      ...
      <form onSubmit={handleSubmit((e)=>{
        ...
        handleLogin(e)
                ...
                <div className='    cont_input '>
                 ...
                 <input className=' bg-primary pb-[0.875vh] focus:border-primaryBlack focus:ring-0 w-full inp ' {...register("password",{required:"*Đây là trường bắt buộc"})} type={isShowPass?"text":"password"} placeholder='   Mật Khẩu' 
                 />
