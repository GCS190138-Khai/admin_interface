...
function Register() {
  ...
  const handleLogin= async (data)=>{ 
   ...
   const res = await  registerUser(newUser,dispatch,currentUser,axiosJWT,navigate)
      ...
      <form onSubmit={handleSubmit((e)=>{
        ...
        handleLogin(e)
                ...
                <div className=' cont_input   '>
                  <input className=' bg-primary pb-[0.875vh] focus:border-primaryBlack  focus:ring-0 w-full  inp' {...register("name",{required:"*Đây là trường bắt buộc"})} type="text" placeholder='   Họ & Tên*' 
                   />
                ...
                {/*  */}
                <div className=' cont_input   '>
                  <input className=' bg-primary pb-[0.875vh] focus:border-primaryBlack  focus:ring-0 w-full  inp' {...register("phone",{required:"*Đây là trường bắt buộc",min:{
                    value:9,
                ...
                <div className=' cont_input   '>
                  <input className=' bg-primary pb-[0.875vh] focus:border-primaryBlack  focus:ring-0 w-full  inp' {...register("username",{required:"*Đây là trường bắt buộc"})} type="text" placeholder='   Tên Người Dùng*' 
                   />
